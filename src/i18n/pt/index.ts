...
const pt = {
	...
	EditReviews: {
		...
		EditCategory: "Editar categoria",
		EditReviewValidationFail: "Erro ao tentar editar a avaliação. Tente de novo",
		EditReviewValidationSuccess: "Editar avaliação com sucesso",
		LanguageDesc: "Selecione para quais idiomas deseja criar a categoria.",
		LanguageTitle: "Selecione o(s) idioma(s)",
		NoCategories: "Não existem categorias na base de dados com os idiomas que deseja",
		NoEvaluation: "Avaliação não encontrada",
		NoLanguagesMatching: "Nem todas as categorias têm todas as linguagens selecionadas",
		NoRatingGroups: "Não existem critérios de avaliação na base de dados com os idiomas que deseja",
		NoSelectionLanguages: "Selecione pelo menos uma linguagem para a qual será criada a avaliação",
	...
	SingleReview: {
		...
		ActionsCancelModal: "Tem a certeza que pretende cancelar a avaliação? Esta ação não pode ser revertida.",
		...
		ActionsCompleteModal: "Tem a certeza que pretende finalizar a avaliação? Esta ação não pode ser revertida.",
